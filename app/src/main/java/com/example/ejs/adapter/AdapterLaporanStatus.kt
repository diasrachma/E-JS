...
class AdapterLaporanStatus (val dataBuktiPegawai: List<HashMap<String,String>>)
    : RecyclerView.Adapter<AdapterLaporanStatus.HolderBuktiPerpegawai>() {
            ...
            contextMenu.setOnMenuItemClickListener { item ->
                when(item.itemId){
                    R.id.contextQr -> {
                        ...
                        dialog.show((it.context as AppCompatActivity).supportFragmentManager, "qrFragment")
                    }
                }
                false
            }
